...
class TestAccountingService:
    ...
    def test_get_financial_summary_success(self, app):
        ...
        with app.app_context():
            ...
            assert result['summary']['net_profit'] == 1700.0
    ...
    def test_get_customer_analysis_all_customers(self, app):
        ...
        with app.app_context():
            ...
            assert customer1_analysis['invoice_count'] == 2
            assert customer1_analysis['total_amount'] == 2500.0
    ...
    def test_get_invoice_status_summary_success(self, app):
        ...
        with app.app_context():
            ...
            assert by_status['paid']['total_amount'] == 2500.0
    ...
    def test_get_profit_loss_statement_success(self, app):
        ...
        with app.app_context():
            ...
            assert result['profit_loss']['revenue']['total_revenue'] == 2500.0
            assert result['profit_loss']['expenses']['total_expenses'] == 800.0
    ...
    def test_get_transaction_summary_by_type_success(self, app):
        ...
        with app.app_context():
            ...
            assert summary['income']['total_amount'] == 2500.0
            assert summary['income']['average_amount'] == 1250.0
            
            assert summary['expense']['count'] == 2
            assert summary['expense']['total_amount'] == 800.0
            assert summary['expense']['average_amount'] == 400.0
    ...
    def test_profit_margin_calculation(self, app):
        ...
        with app.app_context():
            ...
            expected_margin = (1700.0 / 2500.0) * 100
